...
This section is for contributors to the Everything Presence Grid codebase — the
Python Home Assistant integration, the TypeScript/Lit panel that ships inside
it, the ESPHome-based firmware, and this docs site. For end-user documentation
(installation, flashing, zone configuration, automations), see the
